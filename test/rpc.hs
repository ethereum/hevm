...
weth9VM :: W256 -> (Expr Buf, [Prop]) -> IO (VM SymGas RealWorld)
...
vmFromRpc :: Gas g => W256 -> (Expr Buf, [Prop]) -> Expr EWord -> Expr EAddr -> Addr -> IO (VM g RealWorld)
