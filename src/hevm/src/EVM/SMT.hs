...
prelude =  (flip SMT2) mempty $ fmap (T.drop 2) . T.lines $ [i|
  ...
  (define-fun signext ( (sz (_ BitVec 256)) (val (_ BitVec 256))) (_ BitVec 256) (
     ite (= sz (_ bv0  256)) (_ bv0 256)
    (ite (= sz (_ bv1  256)) ((_ sign_extend 248) ((_ extract 7    0) val))
    (ite (= sz (_ bv2  256)) ((_ sign_extend 240) ((_ extract 15   0) val))
    (ite (= sz (_ bv3  256)) ((_ sign_extend 232) ((_ extract 23   0) val))
    (ite (= sz (_ bv4  256)) ((_ sign_extend 224) ((_ extract 31   0) val))
    (ite (= sz (_ bv5  256)) ((_ sign_extend 216) ((_ extract 39   0) val))
    (ite (= sz (_ bv6  256)) ((_ sign_extend 208) ((_ extract 47   0) val))
    (ite (= sz (_ bv7  256)) ((_ sign_extend 200) ((_ extract 55   0) val))
    (ite (= sz (_ bv8  256)) ((_ sign_extend 192) ((_ extract 63   0) val))
    (ite (= sz (_ bv9  256)) ((_ sign_extend 184) ((_ extract 71   0) val))
    (ite (= sz (_ bv10 256)) ((_ sign_extend 176) ((_ extract 79   0) val))
    (ite (= sz (_ bv11 256)) ((_ sign_extend 168) ((_ extract 87   0) val))
    (ite (= sz (_ bv12 256)) ((_ sign_extend 160) ((_ extract 95   0) val))
    (ite (= sz (_ bv13 256)) ((_ sign_extend 152) ((_ extract 103  0) val))
    (ite (= sz (_ bv14 256)) ((_ sign_extend 144) ((_ extract 111  0) val))
    (ite (= sz (_ bv15 256)) ((_ sign_extend 136) ((_ extract 119  0) val))
    (ite (= sz (_ bv16 256)) ((_ sign_extend 128) ((_ extract 127  0) val))
    (ite (= sz (_ bv17 256)) ((_ sign_extend 120) ((_ extract 135  0) val))
    (ite (= sz (_ bv18 256)) ((_ sign_extend 112) ((_ extract 143  0) val))
    (ite (= sz (_ bv19 256)) ((_ sign_extend 104) ((_ extract 151  0) val))
    (ite (= sz (_ bv20 256)) ((_ sign_extend 96 ) ((_ extract 159  0) val))
    (ite (= sz (_ bv21 256)) ((_ sign_extend 88 ) ((_ extract 167  0) val))
    (ite (= sz (_ bv22 256)) ((_ sign_extend 80 ) ((_ extract 175  0) val))
    (ite (= sz (_ bv23 256)) ((_ sign_extend 72 ) ((_ extract 183  0) val))
    (ite (= sz (_ bv24 256)) ((_ sign_extend 64 ) ((_ extract 191  0) val))
    (ite (= sz (_ bv25 256)) ((_ sign_extend 56 ) ((_ extract 199  0) val))
    (ite (= sz (_ bv26 256)) ((_ sign_extend 48 ) ((_ extract 207  0) val))
    (ite (= sz (_ bv27 256)) ((_ sign_extend 40 ) ((_ extract 215  0) val))
    (ite (= sz (_ bv28 256)) ((_ sign_extend 32 ) ((_ extract 223  0) val))
    (ite (= sz (_ bv29 256)) ((_ sign_extend 24 ) ((_ extract 231  0) val))
    (ite (= sz (_ bv30 256)) ((_ sign_extend 16 ) ((_ extract 239  0) val))
    (ite (= sz (_ bv31 256)) ((_ sign_extend 8  ) ((_ extract 247  0) val)) val)))))))))))))))))))))))))))))))))
