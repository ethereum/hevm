...
import Data.Bits (Bits, FiniteBits, shift, shiftL, shiftR, (.&.), (.|.))
...
regexMatches regexSource =
  let compOpts =
   ...
   in Regex.matchTest regex . Seq.fromList . Text.unpack
