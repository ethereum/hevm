{
  ...
  inputs = {
    ...
    # this is moderately incestuous since dapptools depends on us, but we're
    # only using it here to build projects and make sure we correctly parse the
    # build output generated by dapp build
